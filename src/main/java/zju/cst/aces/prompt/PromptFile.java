...
public enum PromptFile {
    ...
    // For SCOUT
    scout_initial_no_deps("PROMPT_TEMPLATE_SCOUT_INITIAL_NO_DEPS", "PROMPT_TEMPLATE_INIT_SYSTEM"),
    scout_initial_with_deps("PROMPT_TEMPLATE_SCOUT_INITIAL_WITH_DEPS", "PROMPT_TEMPLATE_INIT_SYSTEM"),
    scout_error("PROMPT_TEMPLATE_SCOUT_ERROR", "PROMPT_TEMPLATE_INIT_SYSTEM"),
    scout_fail("PROMPT_TEMPLATE_SCOUT_FAIL", "PROMPT_TEMPLATE_INIT_SYSTEM");
    // 成员变量
