...
public class JavaParserUtil {
    ...
    public  NodeList<CompilationUnit> getParseResult(){
        ...
        // System.out.println("CLASS PATHSS?");
        for (String classPath : classPaths) {
            // System.out.println(classPath);
            // if (classPath.contains("module-info")) {
            //     continue;
            // }
        ...
        // System.out.println("CLASS PATH DONE");
...
//        }
    ...
    public MethodExampleMap createMethodExampleMap(NodeList<CompilationUnit> cus) {
        config.getLogger().info("Starting to create method example map... - JavaParserUtil");
        MethodExampleMap methodExampleMap = new MethodExampleMap();
        SDG sdg = createSDG(cus);
        config.getLogger().info("Starting to create method example map... - JavaParserUtil2");
        ...
        config.getLogger().info("Starting to create method example map... - JavaParserUtil3");
