    ...
    public class Builder extends ESCFG.Builder {
        ...
        public void visit(ConstructorDeclaration n, Void arg) {
            ...
            if (ASTUtils.shouldInsertExplicitConstructorInvocation(n)) {
                ExplicitConstructorInvocationStmt superCall = new ExplicitConstructorInvocationStmt(null, null, false, null, new NodeList<>());
            ...
            ReturnStmt returnThis = new ReturnStmt();
        ...
        protected void expandOutputVariable(CallableDeclaration<?> callableDeclaration, VariableAction useOutput) {
            ...
            Optional<ObjectTree> fields = classGraph.generateObjectTreeForReturnOf(callableDeclaration);
            if (fields.isPresent()) {
